...
public class PropImitationHooks {
    ...
    static {
        ...
        sP7Props.put("FINGERPRINT", "google/cheetah/cheetah:13/TQ1A.230105.002/9325679:user/release-keys");
    }
    ...
    public static void setProps(Application app) {
        ...
        if (!sCertifiedFp.isEmpty() && (sIsGms || sIsFinsky)) {
            ...
            setPropValue("FINGERPRINT", sStockFp);
                            ...
                            || packageName.equals(PACKAGE_GBOARD) || packageName.equals(PACKAGE_SUBSCRIPTION_RED) || packageName.equals(PACKAGE_WILDLIFE)) {
