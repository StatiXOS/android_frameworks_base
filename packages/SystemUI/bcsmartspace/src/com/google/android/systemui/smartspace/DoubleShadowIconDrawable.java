...
public final class DoubleShadowIconDrawable extends Drawable {
    ...
    public static RenderEffect createShadowRenderEffect(int i, int i2, int i3, int i4) {
        float f = i;
        return RenderEffect.createColorFilterEffect(new PorterDuffColorFilter(Color.argb(i4, 0, 0, 0), PorterDuff.Mode.MULTIPLY), RenderEffect.createOffsetEffect(i2, i3, RenderEffect.createBlurEffect(f, f, Shader.TileMode.CLAMP)));
    }
