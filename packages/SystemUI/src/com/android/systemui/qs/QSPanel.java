        ...
        mMinBrightness.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentValue != 0) {
                    ...
                    mBrightnessController.setBrightness(tracking,stopTracking,Math.max(0, brightness));
                }
            }
        });
        ...
        mMaxBrightness.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currentValue != 255) {
                    ...
                    mBrightnessController.setBrightness(tracking,stopTracking,Math.min(255, brightness));
                }
            }
        });
