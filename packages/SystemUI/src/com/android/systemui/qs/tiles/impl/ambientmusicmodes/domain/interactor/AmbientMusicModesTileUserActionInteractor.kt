...
constructor(
    ...
    val longClickIntent = Intent(Settings.ACTION_ZEN_MODE_SETTINGS) // TMP
    ...
    suspend fun handleToggleClick(ambientMusicModesTileModel: AmbientMusicModesTileModel) {
        // Do nothing
    }
    ...
    companion object {
        const val TAG = "AmbientMusicModesTileUserActionInteractor"
    }
}
